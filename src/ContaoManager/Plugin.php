...
use MetaModels\AttributeTranslatedTextBundle\MetaModelsAttributeTranslatedTextBundle;
...
class Plugin implements BundlePluginInterface
{
    ...
    {
        return [
            BundleConfig::create(MetaModelsAttributeTranslatedTextBundle::class)
                ->setLoadAfter(
                    [
                ...
                ->setReplace(['metamodelsattribute_translatedtext'])
        ];
    }
}
